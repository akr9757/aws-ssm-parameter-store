parameters = [
  ...
  { name = "prod.user.redis_host", value = "elasticache-dev-elasticache.willem.ng.0001.use1.cache.amazonaws.com" },
  { name = "prod.cart.redis_host", value = "elasticache-dev-elasticache.willem.ng.0001.use1.cache.amazonaws.com" },
